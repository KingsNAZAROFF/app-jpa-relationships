...
public class StudentController {
    ...
    public Page<Student> getStudentListForDekanat(@PathVariable Integer dekanatId, @RequestParam int page){
        Pageable pageable = PageRequest.of(page,10);
    ...
    public Page<Student> getStudentListForGroupOwner(@PathVariable Integer groupId,@RequestParam int page){
        Pageable pageable = PageRequest.of(page,10);
        Page<Student> studentPage = studentRepository.findByGroupId(groupId,pageable);
        return studentPage;
    }
